...
export function placeSquareChairs(
  ...
  if (frontCount > 0) {
    ...
    for (const x of xs) {
      positions.push(new Vector3(x, 0, tableMin.z - 0.25));
    }
  }
  ...
  if (backCount > 0) {
    ...
    for (const x of xs) {
      positions.push(new Vector3(x, 0, tableMax.z + 0.25));
    }
  }
  ...
  if (leftCount > 0) {
    ...
    for (const z of zs) {
      positions.push(new Vector3(tableMin.x - 0.25, 0, z));
    }
  }
  ...
  if (rightCount > 0) {
    ...
    for (const z of zs) {
      positions.push(new Vector3(tableMax.x + 0.25, 0, z));
    }
  }
